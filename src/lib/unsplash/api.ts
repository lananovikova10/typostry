...
import { UnsplashPhoto, UnsplashRandomPhotoParams, UnsplashRandomPhotoResponse } from "./types";
 ...
 */
export async function getRandomPhoto(params?: UnsplashRandomPhotoParams): Promise<UnsplashPhoto | UnsplashPhoto[]> {
 ...
 */
export async function getRandomPhotoAsMarkdown(params?: UnsplashRandomPhotoParams): Promise<string> {
  try {
