...
const setupFilePicker = (fileContent = "# Test Content", fileName = "test.md") => {
...
describe("MarkdownEditor", () => {
  ...
  test("creates a new file", () => {
    ...
    render(<MarkdownEditor initialValue={initialValue} onChange={handleChange} />)
  ...
  test("saves a file using File System Access API", async () => {
    ...
    render(<MarkdownEditor initialValue="# Test Content" onChange={handleChange} />)
