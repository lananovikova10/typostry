...
export function useIsTheme() {
  ...
  return {
    ...
    isDark: mounted && (theme === "dark" || theme === "high-contrast-dark" || theme === "acid" || theme === "catppuccin-mocha" || (theme === "system" && resolvedTheme === "dark")),
    ...
    isCatppuccin: mounted && theme === "catppuccin-mocha",
